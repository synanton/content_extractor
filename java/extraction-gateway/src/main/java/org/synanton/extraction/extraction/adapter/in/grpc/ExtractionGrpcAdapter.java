...
import org.synanton.extraction.extraction.adapter.out.persistence.JdbcIdempotencyStore.IdempotencyStoreUnavailableException;
...
import org.synanton.extraction.spi.spi.port.ResultStore;
import org.synanton.extraction.v1.CancelOperationRequest;
import org.synanton.extraction.v1.CapacityResponse;
import org.synanton.extraction.v1.ExtractionCapabilities;
...
import org.synanton.extraction.v1.GetCapacityRequest;
import org.synanton.extraction.v1.GetCapabilitiesRequest;
...
import org.synanton.extraction.v1.MediaTypeCapability;
...
public class ExtractionGrpcAdapter extends ExtractionServiceGrpc.ExtractionServiceImplBase {
    ...
    private static SyncExtractionOutcome failedOutcome(GetResultRequest request, ItemRecord item) {
        return new SyncExtractionOutcome(
                ...
                null,
                item.featureStates(),
                ExtractionFailure.internalError("Result not found"),
                null,
                "");
    }
